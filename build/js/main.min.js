...
/* harmony import */ var _modules_modals_scroll_to_block__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/scroll-to-block */ "./js/modules/modals/scroll-to-block.js");
/* harmony import */ var _modules_modals_play_video__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/play-video */ "./js/modules/modals/play-video.js");
/* harmony import */ var _modules_modals_open_tab__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/open-tab */ "./js/modules/modals/open-tab.js");
/* harmony import */ var _vendor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./vendor */ "./js/vendor.js");
/* harmony import */ var _modules_modals_phone_mask__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/modals/phone-mask */ "./js/modules/modals/phone-mask.js");
/* harmony import */ var _modules_modals_check_webp_support__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/modals/check-webp-support */ "./js/modules/modals/check-webp-support.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_check_webp_support__WEBPACK_IMPORTED_MODULE_7__["checkSupport"])();
  Object(_modules_modals_scroll_to_block__WEBPACK_IMPORTED_MODULE_2__["scrollToBlock"])();
  Object(_modules_modals_play_video__WEBPACK_IMPORTED_MODULE_3__["playVideo"])();
  Object(_modules_modals_open_tab__WEBPACK_IMPORTED_MODULE_4__["openTab"])();
  Object(_vendor__WEBPACK_IMPORTED_MODULE_5__["runStaffSlider"])();
  Object(_vendor__WEBPACK_IMPORTED_MODULE_5__["runReviewsSlider"])();
  Object(_modules_modals_phone_mask__WEBPACK_IMPORTED_MODULE_6__["makeMaskForPhoneInputs"])();
...
/***/ "./js/modules/modals/check-webp-support.js":
/*!*************************************************!*\
  !*** ./js/modules/modals/check-webp-support.js ***!
  \*************************************************/
/*! exports provided: checkSupport */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var tabs = document.querySelectorAll('[data-tab-content]');
function openTab() {
  if (triggers || tabs) {
    triggers.forEach(function (trigger) {
      trigger.addEventListener('click', function (evt) {
        ...
        triggers.forEach(function (child) {
...
/***/ "./js/modules/modals/phone-mask.js":
/*!*****************************************!*\
  !*** ./js/modules/modals/phone-mask.js ***!
  \*****************************************/
/*! exports provided: makeMaskForPhoneInputs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeMaskForPhoneInputs", function() { return makeMaskForPhoneInputs; });
...
function makeMaskForPhoneInputs() {
  var phoneInputElements = document.querySelectorAll('[data-phone-input]');
  var _iterator = _createForOfIteratorHelper(phoneInputElements),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var phoneInput = _step.value;
      for (var _i = 0, _arr = ['input', 'blur', 'focus', 'keydown', 'click']; _i < _arr.length; _i++) {
        var ev = _arr[_i];
...
function makeMask(evt) {
  var el = evt.target;
  var clearVal = el.dataset.phoneInputClear;
  var pattern = el.dataset.phoneInput;
  var matrixDef = '+7(___) ___-__-__';
  var matrix = pattern ? pattern : matrixDef;
  var i = 0;
  var definition = matrix.replace(/\D/g, '');
  var elementValue = el.value.replace(/\D/g, '').replace(/^78/, '7');
  var CURSOR_START_POSITION = 3;
...
/***/ "./js/modules/modals/play-video.js":
/*!*****************************************!*\
  !*** ./js/modules/modals/play-video.js ***!
  \*****************************************/
...
/***/ "./js/modules/modals/scroll-to-block.js":
/*!**********************************************!*\
  !*** ./js/modules/modals/scroll-to-block.js ***!
  \**********************************************/
/*! exports provided: scrollToBlock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function scrollToBlock() {
  var anchorElements = document.querySelectorAll('[data-scroll-to-block]');
  if (anchorElements) {
...
/*!**********************!*\
  !*** ./js/vendor.js ***!
  \**********************/
/*! exports provided: runStaffSlider, runReviewsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "runStaffSlider", function() { return runStaffSlider; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "runReviewsSlider", function() { return runReviewsSlider; });
...
var staffCarousel = document.querySelector('.staff__slider-container');
var reviewsSlider = document.querySelector('.reviews__carousel-wrapper');
function runStaffSlider() {
  if (staffCarousel) {
    var swiper = new Swiper(staffCarousel, {
      slidesPerView: 4,
      spaceBetween: 40,
      slidesPerGroup: 1,
      loop: true,
